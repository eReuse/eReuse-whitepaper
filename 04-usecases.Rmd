...
## Lead beneficiaries of the solution
...
Testimonials: \> As a (user) \_\_\_ I Can (action) \_\_\_\_ So that (value for the user) \_\_\_\_

#### Questions an value for the user
...
1.  Puedo saber las horas de extensión de tiempo de vida de los dispositivos que di a un refurbisher o a un final user

2.  Puedo saber si los refurbishers y los final users han reciclado los dispositivos.

### Refurbishers: Business collecting, repairing and reselling devices 
...
1.  Puedo generar un documento (online) con una descripción del dispositivo(s), y:

    1.  el comprador de manera online puede verificar que el documento:

        1.  está en un repositorio inmutable

        2.  se ha generado con un software (no de manera manual)

    2.  Cuando el comprador recibe físicamente el dispositivo(s) puede:

        1.  Validar que se trata del mismo producto que compró online

        2.  Puede regenerar el documento y verificar que coincide con el del comprador

**Role Disposition for reuse manager**

As refurbisher with role of (Disposition Manager) I can:

1.  Puedo generar un documentos de **cadena de custódia** con anonimización de usuarios, en donde se explícita si han confirmado o no las transferencia y el tipo de rol de usuario, ejemplos:

    -   User 1 is a Donor (confirm) -\> User 2 is a Disposition Manager (confirm) -\> User 3 is a Final User (confirmed) -\> User 4 is a Recycler (confirmed)

    -   ....

2.  Puedo generar informes de impacto a mis donantes/vendedores con información de la extensión de tiempo de vida y de llegada a un centro de reciclaje autorizado
