...
\begin{quote}
Who is the lead beneficiary of the solution? Explain the type of users that would benefit from the solution, or who will be part of the pilot. Explain the solution, what problem does it solve, and what is the intended user experience. For example, you could use the use case from the view of the user, as if it was a testimonial: As a (user) \_\_\_ I Can (action) \_\_\_\_ So that (value for the user) \_\_\_\_
\end{quote}

\hypertarget{lead-beneficiaries-of-the-solution}{%
\section{Lead beneficiaries of the solution}\label{lead-beneficiaries-of-the-solution}}
...
\begin{itemize}
\item
  Business and governments disposing for reuse
\item
  Business collecting, repairing and reselling devices: Refurishers
\item
  Final Users
\item
  Recyclers
...
\hypertarget{business-and-governments-disposing-for-reuse}{%
\subsection{Business and governments disposing for reuse}\label{business-and-governments-disposing-for-reuse}}

Governments and business want to dispose of used IT devices such as computers and laptops.
...
Testimonials: \textgreater{} As a (user) \_\_\_ I Can (action) \_\_\_\_ So that (value for the user) \_\_\_\_

\hypertarget{questions-an-value-for-the-user}{%
\subsubsection{Questions an value for the user}\label{questions-an-value-for-the-user}}
...
As the business disposing out-of-use devices I can :

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  Puedo saber las horas de extensión de tiempo de vida de los dispositivos que di a un refurbisher o a un final user
\item
  Puedo saber si los refurbishers y los final users han reciclado los dispositivos.
\end{enumerate}

\hypertarget{refurbishers-business-collecting-repairing-and-reselling-devices}{%
\subsection{Refurbishers: Business collecting, repairing and reselling devices}\label{refurbishers-business-collecting-repairing-and-reselling-devices}}

Are business that collect, refurbish and deliver 2nd-hand devices to retailers (B2B) or to business and citizens B2C (Final Users).

For simplicity we define refurbishers as businesses that do not have the roles of recyclers and therefore always deal with products and not waste. However we can have cases of refurbishers with also the roles of recyclers.
...
\hypertarget{questions-an-value-for-the-user-1}{%
\subsubsection{Questions an value for the user}\label{questions-an-value-for-the-user-1}}
...
\def\labelenumi{\arabic{enumi}.}
\item
  Puedo generar un documento (online) con una descripción del dispositivo(s), y:

  \begin{enumerate}
  \def\labelenumii{\arabic{enumii}.}
  \item
    el comprador de manera online puede verificar que el documento:

    \begin{enumerate}
    \def\labelenumiii{\arabic{enumiii}.}
    \item
      está en un repositorio inmutable
    \item
      se ha generado con un software (no de manera manual)
    \end{enumerate}
  \item
    Cuando el comprador recibe físicamente el dispositivo(s) puede:

    \begin{enumerate}
    \def\labelenumiii{\arabic{enumiii}.}
    \item
      Validar que se trata del mismo producto que compró online
    \item
      Puede regenerar el documento y verificar que coincide con el del comprador
    \end{enumerate}
  \end{enumerate}
\end{enumerate}

\textbf{Role Disposition for reuse manager}

As refurbisher with role of (Disposition Manager) I can:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  Puedo generar un documentos de \textbf{cadena de custódia} con anonimización de usuarios, en donde se explícita si han confirmado o no las transferencia y el tipo de rol de usuario, ejemplos:

  \begin{itemize}
  \item
    User 1 is a Donor (confirm) -\textgreater{} User 2 is a Disposition Manager (confirm) -\textgreater{} User 3 is a Final User (confirmed) -\textgreater{} User 4 is a Recycler (confirmed)
  \item
    \ldots.
  \end{itemize}
\item
  Puedo generar informes de impacto a mis donantes/vendedores con información de la extensión de tiempo de vida y de llegada a un centro de reciclaje autorizado

  \begin{itemize}
  \item
    De los 100 dispositivos del donante tenemos que:
...
As refurbisher with role of (Repairer) I can:
...
\textbf{Role Seller (Exporter)}

As refurbisher with role of (seller exporter) I can:

TODO

\hypertarget{final-users}{%
\subsection{Final Users}\label{final-users}}
