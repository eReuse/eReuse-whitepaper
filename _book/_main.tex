...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{path\_req }\OtherTok{\textless{}{-}} \StringTok{"/home/david/NextCloud/David{-}Tesi/eReuseMetrics/code/requirements"}
\FunctionTok{source}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(path\_req,}\StringTok{"libraries.R"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{our-activity}{%
\section{Our activity}\label{our-activity}}
...
\hypertarget{our-members-and-partners}{%
\section{Our members and partners}\label{our-members-and-partners}}

Ereuse.org is a cluster of organisations dedicated to the transition to collaborative and circular consumption of electronics. Our federated members are local groups, business and organizations with the goal to extend the lifetime of products through repair, refurbish, retail and in general reuse.
